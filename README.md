...
Gunakan perintah berikut untuk menjalankan server dengan mode _auto-restart_ (Nodemon):
...
| `GET`    | `/api/users/murid{id}`   | Mengambil data murid berdasarkan id             | Private (JWT) |
...
| `GET`    | `/api/users/tentor/{id}` | Mengambil data tentor yang aktif berdasarkan id | Private (JWT) |
...
| Method   | Endpoint                  | Deskripsi                               | Akses         |
| :------- | :------------------------ | :-------------------------------------- | :------------ |
| `GET`    | `/api/kelas`              | Menampilkan seluruh daftar kelas        | Private (JWT) |
| `POST`   | `/api/kelas`              | Membuat kelas bimbingan baru            | Private (JWT) |
| `GET`    | `/api/kelas/{id}`         | Menampilkan data kelas berdasarkan id   | Private (JWT) |
| `PUT`    | `/api/kelas/{id}`         | Memperbarui informasi atau status kelas | Private (JWT) |
| `Delete` | `/api/kelas/{id}`         | Menghapus Data Kelas Secara permanen    | Private (JWT) |
...
| `GET`    | `/api/kelas/{id}/anggota` | Melihat daftar murid di suatu kelas     | Private (JWT) |
